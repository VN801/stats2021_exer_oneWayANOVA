...
\##`{r} I added the the hashtags as I could not Knit this to a Markdown because of this error. jmv::ANOVA(   formula = Happiness ~ Dose,   data = dataset,   effectSize = c("partEta", "omega"),   homo = TRUE,   norm = TRUE,   qq = TRUE,   postHoc = ~ Dose,   postHocCorr = c("tukey", "holm"),   postHocES = "d")`\##
